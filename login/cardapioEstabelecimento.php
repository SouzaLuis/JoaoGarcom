...
<body style="min-width:372px;">
                                    ...
                                    <div class="card text-center">
                                        <div class="card-body">
                                            ...
                                            <form method="POST">
                                                ...
                                                <input type="submit" style="background-color: rgb(160,4,4);width:150x;float:right" class="btn btn-danger btn-lg" value="Apagar">
                                            </form>
                                        </div>
                                    </div>
                                </div>
    ...
    <br>
    <footer class="footer mt-auto py-3" style="background-color: rgb(160,4,4); width: 100%; height:50px">
